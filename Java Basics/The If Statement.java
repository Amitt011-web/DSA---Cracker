/**
*
* Given a number n, use the if statement to print "Big" (without quotes) if the given number is greater than 100. The statement "Number"
* (without quotes) will be printed regardless.
